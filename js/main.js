...
const sendEmail = (e) =>{
    ...
    //serviceID-templateID-#form-publickey of emailjs account
    emailjs.sendForm('service_9da7tni','template_csammlm','#contact-form','Gv01gwaHNLCk8w-6k').then(()=>{
...
/*=============== SHOW SCROLL UP ===============*/ 
const scrollUp1 = () =>{
	const scrollUp2 = document.getElementById('scroll-up')
    // When the scroll is higher than 350 viewport height, add the show-scroll class to the a tag with the scrollup class
	this.scrollY >= 350 ? scrollUp2.classList.add('show-scroll') : scrollUp2.classList.remove('show-scroll')
}
